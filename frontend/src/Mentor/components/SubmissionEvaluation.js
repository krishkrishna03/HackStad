...
//   const [onEvaluate, setOnEvaluate] = useState(null);
...
//         // Ensure we extract the first submission if the array is not empty
...
//               <button
//                 onClick={() => onEvaluate({ status: 'approved', marks, feedback })}
...
//               </button>
//               <button
//                 onClick={() => onEvaluate({ status: 'rejected', marks: 0, feedback })}
