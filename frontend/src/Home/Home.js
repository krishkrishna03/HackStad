  ...
  const mentors = [
    {
      ...
      experience: "12+ years",
      description: "Leading expert in AI research with 50+ published papers and former Google AI researcher.",
      icon: Brain,
      achievements: ["PhD from MIT", "Google AI Alumni", "50+ Research Papers"],
    ...
    },
    {
      ...
      experience: "15+ years",
      description: "Cloud architecture specialist helping teams scale applications to millions of users.",
      icon: Cloud,
      achievements: ["Microsoft MVP", "AWS Solutions Architect", "Kubernetes Expert"],
      social: { linkedin: "#", twitter: "#", github: "#" }
    },
    {
      name: "Emily Watson",
      ...
      experience: "10+ years",
      description: "Product strategist who has launched 25+ successful products and mentored 100+ startups.",
      icon: Target,
      achievements: ["Design Thinking Expert", "25+ Product Launches", "Startup Mentor"],
      social: { linkedin: "#", twitter: "#", github: "#" }
    }
  ];
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="flex flex-wrap gap-2 justify-center mb-4">
                        <span className="px-3 py-1 bg-purple-400/30 rounded-full text-xs text-purple-200 border border-purple-400/40">
                          {mentor.expertise}
                        </span>
                  ...
                  >
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="relative flex-shrink-0">
                        <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-cyan-400/40">
                          <img
                            src={developer.image}
                            alt={developer.name}
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-cyan-200 text-xs mt-2">{developer.specialty}</p>
                      </div>
                    </div>
                  </div>
                ))}
